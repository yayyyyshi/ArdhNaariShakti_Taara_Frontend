  ...
  const jobData = [
    {
      ...
      image: "https://www.nicepng.com/png/detail/258-2585308_job-search-skills-girl-using-laptop-png.png",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YXBwbGUlMjBsYXB0b3B8ZW58MHx8MHx8fDA%3D",
    ...
    },
    {
      ...
      image: "https://adash.com/img/vibration-diagnostics/what-is-vibration-meter-analyzer.jpg",
    ...
    },
    {
      ...
      image: "https://www.testingtime.com/app/uploads/2022/03/UX-Designer-vs.-UX-Researcher-scaled.jpg",
    ...
    },
    {
      ...
      image: "https://www.idissindia.com/detective-agency/pre-and-post-employment-verificationlog-agency-in-chennai.png",
  ...
  return (
    <div className="jobs-wrapper">
      <div className="jobs-grid">
        {jobData.map((job, idx) => (
          <div className="card-wrapper fade-in" key={idx} style={{ animationDelay: `${idx * 0.1}s` }}>
            <div className="single-blog">
              ...
              <div className="content-wrapper">
                ...
                <p>
                  <a href={job.link} target="_blank" rel="noreferrer" className="read-more-btn">
                    Apply Here
                  </a>
                </p>
              </div>
